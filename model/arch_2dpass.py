...
from model.basic_block import Lovasz_loss
from model.spvcnn import get_model as SPVCNN
from model.base_model import LightningBaseModel
from model.basic_block import ResNetFCN
...
class xModalKD(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        '''
            Caution : Error handle
        '''
        if img_seg_logits.nelement() != 0:
